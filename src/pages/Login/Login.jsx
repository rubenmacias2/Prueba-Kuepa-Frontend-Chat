    ...
    <div className={'contenLogin'}>
      ...
      >
        <Typography sx={{ textAlign: 'center' }} variant='h4' color="white">
          <SchoolIcon sx={{ fontSize: '40pt' }} /><br />
          Login
        </Typography>

        <form onSubmit={handleLogin}> {/* Agregamos el formulario y el evento onSubmit */}
          <TextField
        ...
        <Box sx={{ textAlign: 'center', paddingTop: 2, color: 'white' }}>
          <Typography variant="body2" color="inherit">
            ...
            <br />
            <Link onClick={() => navigate('/register')} underline="hover" sx={{ cursor: 'pointer' }} color="inherit">
              Regístrate aquí
            </Link>
          </Typography>
        </Box>
